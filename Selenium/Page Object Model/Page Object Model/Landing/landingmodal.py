...
class LandingModal(BaseModal):
    ...
    def enter_login_email(self):
        self.send_data(LandingModalElement.login_email_CSS, UserInformation.login_email)

    def enter_login_password(self):
        self.send_data(LandingModalElement.login_pass_CSS, UserInformation.login_pass)
